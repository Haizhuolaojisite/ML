...
% Setup some useful variables,indicate how many rows does X have
m = size(X, 1);
...
X = [ones(m,1),X];  %Adding 1 as 1st column in X
a1 = X; % 5000 x 401
z2 = a1 * Theta1';
a2= sigmoid(z2);
...
h_x = a3;
y_Vec = (1:num_labels)==y % m*num_labels == 5000 x 10
...
%               first time.
A1 = X; %Here X is including 1 column at begining, 5000X401
Z2 = A1 * Theta1';
A2 = sigmoid(Z2);
A2 = [ones(size(A2,1),1),A2];
